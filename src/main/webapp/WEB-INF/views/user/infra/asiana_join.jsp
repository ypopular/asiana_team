...
<head>
    ...
    <link rel="stylesheet" href="resources/css/asiana_join.css">
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="sm_wrap">
            <div class="smallBox_en">
                <p>영문명</p>
            </div>
            <input type="text" placeholder="영문이름 입력">
        </div>
        <div class="sm_wrap">
            <div class="smallBox">
                <p>성별</p>
        ...
        <div class="sm_wrap_id">
            <div class="smallBox_id">
                <p>아이디</p>
            </div>
            <input type="text" placeholder="6~15자리 영문+숫자">
            <div class="check_btn">중복확인</div>
            <div class="t_box"><p>· 6 ~ 15자리 영문(대소문자 구별),숫자 조합 입력 가능<br>(단,  한글 ,공백, 특수문자 입력 불가)</p></div>
        </div>
        <div class="sm_wrap">
            <div class="smallBox">
                <p>비밀번호</p>
            </div>
            <input type="text" placeholder="영문+숫자+특수문자 8~20자리">
        </div>
        <div class="sm_wrap">
            <div class="smallBox">
                <p>비밀번호 확인</p>
        ...
        <div class="sm_wrap">
            ...
            <select class="phone-select" aria-label="Default select example">
                <option selected>010</option>
            </select>
            <input type="text" class="phone_input">
            <input type="text" class="phone_input">
        </div>
        <div class="sm_wrap_email">
            <div class="smallBox_email">
                <p>이메일</p>
            </div>
            <input type="text" placeholder="이메일 입력" class="email_box">
            <p class="email_p">@</p>
            <select class="form-select_email" aria-label="Default select example">
